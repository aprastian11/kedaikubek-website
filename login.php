...
<html lang="en">
  ...
  <body>
  		<center>
  			<img src="assets/img/pic/fotokubek6.jpeg" alt= "fotokubek " widht ="200px" height ="200px"  style="padding-top:4pc;">
		</center>
	  ...
	  <div id="login-page";>
	  	...
	  	<div class="container">
		      ...
		      <form class="form-login" method="POST">
		        <h2 class="form-login-heading">APLIKASI KEDAI KUBEK</h2>
